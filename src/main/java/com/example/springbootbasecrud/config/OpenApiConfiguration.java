...
public class OpenApiConfiguration {
    ...
    public static final String API_FIRST_PACKAGE = "com.example.springbootbasecrud.controller.api";
    ...
    public GroupedOpenApi apiFirstGroupedOpenAPI(
        ...
        return GroupedOpenApi
            .builder()
            .group("openapi")
            .addOpenApiCustomiser(new JHipsterOpenApiCustomizer(properties))
